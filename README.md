# New Home Loan Purchase — Deployment Checklist
...
3. **Verify your sending domain in Resend**
   Log in to resend.com and verify `newhomeloanpurchase.com` so `leads@newhomeloanpurchase.com` is authorized to send.
...
`🏠 New Lead: [Name] — [Loan Type] — newhomeloanpurchase.com`
